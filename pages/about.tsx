          ...
          <div className="flex flex-wrap items-stretch justify-between w-full gap-8 mt-10 md:mt-20 lg:flex-nowrap">
            ...
            <div className="w-full lg:w-[49.32%] pt-18 -mt-18 about-text-container">
              ...
              <p className="text-md leading-[31px] text-body dark:text-grey-600 mt-8">
                Dayo is a graduate of Medical Laboratory Science at the
                University of Ibadan in Nigeria. He currently works as a
              ...
              <p className="text-md leading-[31px] text-body dark:text-grey-600 mt-8">
                Before working at Dojah, he worked as a contract Product
                Designer for Decasoft and Outlierz. He still designs user
                interfaces now and then, and this portfolio website is the
                latest in that stack.
              </p>
              <p className="text-md leading-[31px] text-body dark:text-grey-600 mt-8">
              ...
              <p className="text-md leading-[31px] text-body dark:text-grey-600 mt-8">
                If you'd like to hire him, enquire about his rates or give him
                any kind of feedback, he'll be delighted to hear from you. He's
              ...
              <p className="text-md leading-[31px] text-body dark:text-grey-600 mt-8">
                If you want to learn about Javascript and web development, he
                has a blog on this website. Check it out{' '}
                <Link href="/blog">
