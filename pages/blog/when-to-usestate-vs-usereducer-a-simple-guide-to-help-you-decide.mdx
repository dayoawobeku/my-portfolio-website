export const meta = {
  ...
  time: '10 minute read',
  url: 'https://res.cloudinary.com/dedywga3v/image/upload/v1700572335/gray-lighthouse_tcvopf.png',
  title:
    'gray lighthouse on islet with concrete pathway at daytime, William Bout',
  description:
    'Learn the difference between useState and useReducer in React and when to use each one in your application. This simple guide will help you decide which one to use.',
...
{<Codesandbox src="https://codesandbox.io/embed/vncl4b?view=Editor+%2B+Preview&module=%2Fsrc%2FApp.jsx" />}
...
{<Codesandbox src="https://codesandbox.io/embed/eqyp97?view=Editor+%2B+Preview&module=%2Fsrc%2FApp.jsx" />}
...
{<Codesandbox src="https://codesandbox.io/embed/f7ewpu?view=Editor+%2B+Preview&module=%2Fsrc%2FApp.jsx" />}

{<Text><QuoteText quote="useReducer" /> implementation:

</Text>}

{<Codesandbox src="https://codesandbox.io/embed/y65z6l?view=Editor+%2B+Preview&module=%2Fsrc%2FApp.jsx" />}
...
{<Text>Assume our PM comes to us and says {''}

<ItalicizedText
  text='“Hey, we need to add a couple of
...
{<Codesandbox src="https://codesandbox.io/embed/iddvq0?view=Editor+%2B+Preview&module=%2Fsrc%2FApp.jsx" />}
