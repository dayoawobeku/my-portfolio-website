...
{<Text>In approximately 2 minutes, I'll show you how you can add the beloved
...
<QuoteText quote="useTheme" /> function from which we'll <ExternalUrl text="destructure" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment"/> the <QuoteText quote="theme" /> and <QuoteText quote="setTheme" /> objects from.</Text>}

{<Text>For our styling, Tailwind helps us with this part. All you need to do is
add {''}

<QuoteText quote="dark:..." /> to your className, and Tailwind will do the
rest. </Text>}
