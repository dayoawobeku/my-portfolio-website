...
the currentUser object using the useContext API and use the user directly inside
the WelcomeMessage component.</Text>}
...
into 2 parts. Read the second part where I talk about server cache here.</Text>}
