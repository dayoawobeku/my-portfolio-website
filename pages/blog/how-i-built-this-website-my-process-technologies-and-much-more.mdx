...
export const meta = {
  ...
  time: '8 minute read',
  url: 'https://res.cloudinary.com/dedywga3v/image/upload/v1700572336/lady-riding-bike_fedvaf.png',
...
{<Text>Sometime in January (2022) along with all the new year fever, I thought
it’d be cool to have a website of my own. <BoldText text='TL:DR' /> I completed
and took it live in September.</Text>}

{<Text>Have you tried toggling the dark/light mode? **Oops I removed it.**
...
was proud of what I had done and I asked some of my friends for feedback. Boy, my <BoldText text='“tech”' /> friends loved it! My <BoldText text='“non-tech”' /> friends on the other hand didn't really think it was that great.</Text>}
...
{<Text>For the code snippets, I used {''} <ExternalUrl
      ...
      text="Codemirror"
    />. Their API is pretty simple to set up. For instance, this is all that’s
