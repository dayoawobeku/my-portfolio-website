...
{<Text>Chrome has two main navigation tools: the address bar and the tab bar.

</Text>}

{<Text>Some browsers use an address bar for navigating to websites and a search
bar for conducting web searches. Google's version of these two elements is the
{' '} <BoldText text="Omnibox," /> which combines searching and web addresses
into one bar. As you type, the Omnibox will give you suggestions for websites or
search queries to make web surfing faster and easier.
...
{<Text>Chrome keeps track of your browsing history to give you suggestions when
you're in the Omnibox and to help you find pages you've visited in the past. It
can also decrease loading times for pages you've been to before.
...
{<Text>Chrome can display a lot of file types, including PDFs, images, and
videos, but you have to download them if you want to save them to your
device.</Text>}
...
{<Text>Incognito mode is a private browsing mode that doesn't store your
browsing history, cookies, or other website data. This means that when you're in
incognito mode, Chrome won't remember the sites you visit, and it won't save
your passwords or other information you enter on those sites.</Text>}
...
<AnchorTag text="Settings and Preferences" href="settings-and-preferences" />

{<Text>There's also a settings menu in Chrome where you can customize your
browsing experience, access your syncing settings, manage your Google account
info, adjust your privacy and security settings, and manage your saved
addresses. To access the settings, tap the menu button and then tap {' '}
...
<SideBySideImage
  src1={androidSelectSettings}
  alt1="android settings"
  src2={iosSelectSettings}
  alt2="iOS settings"
/>

{<Text>Here are some of my favorite settings that you can customize:</Text>}

<ListItems
  items={[
    {
      text: [
        <BoldText text="Sync and Google Services:" />,
        <Image
          src={settingsSync}
          alt="settings sync"
          width={393}
          height={895}
        />,
        ' This section lets you manage your Chrome syncing settings, as well as your Google account settings. You can adjust what data is synced between your devices, and you can also manage your Google account information. I talk more about syncing in the section on ',
        <a
    ...
    {
      text: [
        <BoldText text="Privacy and Security:" />,
        <SideBySideImage
          src1={privacyAndSecurity}
          alt1="privacy and security"
          src2={privacyAndSecuritySettings}
          alt2="privacy and security settings"
        />,
        ' This section lets you adjust various privacy and security settings in Chrome. You can manage site settings, control how Chrome handles cookies, and even enable features like Safe Browsing to protect you from malicious websites.',
      ],
    },
    {
      text: [
        <BoldText text="Adresses and more:" />,
        <Image
          src={addressesAndMore}
          alt="addresses and more"
          width={393}
          height={895}
        />,
        ' This section lets you manage your saved addresses. You can add new addresses, edit existing addresses, and delete addresses that you no longer need. It is particularly useful if you frequently shop online and want to save your shipping addresses. Or, if you frequently fill out forms on websites, you can save your addresses to make filling out forms easier.',
      ],
    },
    {
      text: [
        <BoldText text="Payment methods:" />,
        <Image
          src={paymentMethods}
          alt="payment methods"
          width={393}
          height={895}
        />,
        ' This is where you can manage your saved payment methods. You can add new payment methods, edit existing payment methods, and delete payment methods that you no longer need. It is similar to the address settings and is useful if you frequently shop online and want to save your payment methods.',
      ],
    },
  ]}
/>

{<Text>There are a lot of other settings that you can customize such as the
default search engine, the homepage, and the default download location. You can
also customize the appearance of Chrome by changing the theme, font size, and
more.
...
{<Text>One of the most useful features in Google Chrome is the ability to search for text on a web page. To search for text, tap the menu button, and then tap <BoldText text="'Find in page'" />.</Text>
}

<Image src={findInPage} alt="find in page" width={393} height={895} />

{<Text>Type in what you're looking for in the search bar and then tap
...
<Image
  src={findInPageResult}
  alt="find in page result"
  width={393}
  height={895}
/>
...
tabs to rearrange them.</Text>}

<Image src={rearrangeTabs} alt="rearrange tabs" width={393} height={895} />

{<Text> Slick, <ItalicizedText text="huh?" />
...
<Image src={voiceSearch} alt="voice search" width={393} height={895} />
...
{<Text>Tap <BoldText text="'Settings'" />:</Text>}
...
{
  <Text>
    Tap <BoldText text="'Password Manager'" />:
  </Text>
}
<Image src={passwordManager} alt="password manager" width={393} height={895} />
...
ton of features to help you get things done. In this guide, I've covered some of
my favorite Chrome features. I hope you've learned something new and I hope you
enjoy using Chrome as much as I do.
...
{<Text>Thanks for reading! If you enjoyed this user guide, please consider
sharing. Sharing is caring, after all. See you next time!</Text>}
